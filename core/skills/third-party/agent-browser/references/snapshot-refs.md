...
core/bin/agent-browser approach:
```
...
core/bin/agent-browser click @e6

# Fill email input
core/bin/agent-browser fill @e10 "user@example.com"

# Fill password
core/bin/agent-browser fill @e11 "password123"

# Submit the form
core/bin/agent-browser click @e12
```
...
core/bin/agent-browser snapshot -i          # Get refs first
core/bin/agent-browser click @e1            # Use ref

# WRONG
core/bin/agent-browser open https://example.com
core/bin/agent-browser click @e1            # Ref doesn't exist yet!
```
...
core/bin/agent-browser snapshot -i          # Get new refs
...
```bash
core/bin/agent-browser click @e1            # Opens dropdown
core/bin/agent-browser snapshot -i          # See dropdown items
core/bin/agent-browser click @e7            # Select item
```
...
core/bin/agent-browser snapshot @e9
```
...
core/bin/agent-browser scroll down 1000
core/bin/agent-browser snapshot -i

# Or wait for dynamic content
core/bin/agent-browser wait 1000
core/bin/agent-browser snapshot -i
```
...
core/bin/agent-browser snapshot @e5

# Or use get text for content-only extraction
core/bin/agent-browser get text @e5
```
